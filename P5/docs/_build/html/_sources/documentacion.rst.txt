...
.. note:: References used:
    ...
    - `Cross-referencing syntax <https://www.sphinx-doc.org/en/master/usage/restructuredtext/roles.html#cross-referencing-syntax>`_
    - `Cross-referencing with Sphinx <https://docs.readthedocs.io/en/stable/guides/cross-referencing-with-sphinx.html>`_
    - `Cross-link functions <https://stackoverflow.com/questions/71798784/sphinx-autodoc-how-to-cross-link-to-a-function-documented-on-another-page>`_

By explicit targets:
    - Secction: For mathematic fundamentals of the project see :ref:`Teoría de colas <theory-label>` or an overview in :ref:`P5 Teoría de colas <overview-theory-label>` (both within markdown files).
    - Subsection: For results of simulation see :ref:`Resultados del proyecto <resultados-label-target>` subsection.
    - In-line targets: Words on :ref:`parameters <parámetros>` (Although no convenient use within markdown files It can be used in Docstrings).
    - Function: For an example of the auxiliar function see :func:`cadena.dimensionamiento.probabilidades`.
